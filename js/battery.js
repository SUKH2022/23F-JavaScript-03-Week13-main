...
function updateBatteryStatus(battery) {
    ...
    // STEP 3d: Use the battery level to construct the URL for the robohash image
    const robohashURL = `https://robohash.org/${batteryLevel}.png?set=set4`;
    
    // STEP 3e: Create an <img> element to display the robohash image
    const robohashImage = document.createElement('img');
    robohashImage.src = robohashURL;

    // STEP 3f: Append the <img> element to the body of the HTML document
    document.body.appendChild(robohashImage);
}
